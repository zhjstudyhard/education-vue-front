 ...
 * @LastEditTime: 2022-01-25 20:06:20
...
const routes = [{
    ...
    },
    {
        path: '/teacherIndex',
        name: '讲师界面',
        component: () => import('../views/coursePages/teacher/index'),
        meta: {
            title: '讲师界面'
        },
    },
    {
        path: '/allCourseIndex',
        name: '所有课程',
        component: () => import('../views/coursePages/course/index'),
        meta: {
            title: '所有课程'
        },
    },
    {
        path: '/course/:id',
        name: '课程信息',
        component: () => import('../views/coursePages/course/_id'),
        meta: {
            title: '课程信息'
        },
    }
