  ...
  <div class="home-container">
    ...
    >
      ...
      <div>
        <img
          :src="article.avatar"
          style="width: 40px; margin-top: 30px; border-radius: 50%; background-color: black;"
        />
         <span style="font-size: 20px; color: blue;margin-left:20px;center">{{ article.userName }}</span>
      </div>
