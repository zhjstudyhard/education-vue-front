        ...
        <section class="fl t-infor-box c-desc-content">
          <div class="mt20 ml20">
            <section class="t-infor-pic">
              <img
                src= "http://127.0.0.1:8089/api/upload/get/1483060072794841089"
              />
            </section>
            <h3 class="hLh30">
              <span class="fsize24 c-333">{{teacher.name}}&nbsp;高级讲师</span>
            </h3>
            <section class="mt10">
...
import { getTeacherById } from "@/api/teacher/teacher";
export default {
  components: {
    Navbar,
  },
  ...
  methods: {
    queryTeacherInfo() {
      if (this.$route.params && this.$route.params.id) {
        ...
        getTeacherById(data).then(response =>{
