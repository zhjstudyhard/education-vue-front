      ...
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt" v-if="chapterShow && videoShow">
              <a
                :href="
            ...
            <section class="c-attr-mt" v-if="!chapterShow || (chapterShow && !videoShow)">
              <a
                target="_blank"
                title="视频正在发布"
                class="comm-btn c-btn-3"
        ...
        <article class="fl col-7">
          <el-card>
            <el-tabs v-model="activeTab">
              <el-tab-pane label="课程详情" :key="'first'"  name="first">
                <section class="mr30">
                  <div class="i-box">
                    <div>
                      <section
...
export default {
  components: { VideoComment,Navbar },
  data() {
    return {
      activeTab: "first",
      course: {},
    ...
    findByCourseId() {
      if (this.$route.params && this.$route.params.id) {
        ...
        findByCourseId(data).then((response) => {
          ...
          if(this.course.chapterVos.length > 0){
             this.chapterShow = true
          }
          for(let i = 0;i<this.course.chapterVos.length;i++){
              if(this.course.chapterVos[i].children.length > 0){
                 this.videoShow = true
                 break
              }
          }
          console.log("chapterShow: ",this.chapterShow)
