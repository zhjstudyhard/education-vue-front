      ...
      <div>
        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt" v-if="course.chapterVos && course.chapterVos.children">
              <a
                :href="
            ...
            <section class="c-attr-mt" v-if="!course.chapterVos || (course.chapterVos && !course.chapterVos.children)">
              <a
                target="_blank"
                title="立即观看"
                class="comm-btn c-btn-3"
      ...
      if (this.$route.params && this.$route.params.id) {
        ...
        findByCourseId(data).then((response) => {
          ...
          for(let i = 0;i<this.course.length;i++){
              if(this.course[i].children.length > 0){
                 this.videoShow = true
                 break
              }
          }
