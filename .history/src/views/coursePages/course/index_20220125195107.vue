        ...
        <section class="c-s-dl">
          <dl>
            ...
            <dd class="c-s-dl-li">
              <ul class="clearfix">
                <li>
                  <a href="#" @click="searchOne(-1, -1)">全部</a>
...
import { getAllSubject } from "@/api/index/subject";
import { pageListCourse } from "@/api/index/course";
export default {
  data() {
    return {
      data: {}, //课程列表
  ...
  methods: {
    ...
    handleSizeChange(newPageSize) {
      this.searchObj.pageSize = newPageSize;
      this.gotoPage();
    },
    handleCurrentChange(newPage) {
      this.searchObj.currentPage = newPage;
      this.gotoPage();
    },
    //1 查询第一页数据
    initCourseFirst() {
      pageListCourse(this.searchObj).then((response) => {
