 ...
 * @LastEditTime: 2021-12-25 20:14:20
...
//注册
export const queryDictionaryAllPage =(data) => post(`/api/dictionary/queryDictionaryAllPage`,data);
export const queryDictionaryByType =(data) => post(`/api/dictionary/queryDictionaryByType`,data);
